...
We can implement the join between a spatial dataset and a tabular dataset in much the same was as we implemented a join between two tabular datasets above in Section 5.2 (between the traffic stops dataset and the census dataset). 
